...
slopes_df <- tribble(
  ...
  # ---- Full sample ----
  "Full", "Q1", "Below", 0.0162, 0.0001,
  "Full", "Q1", "Above", 0.0025, 0.0003,
  "Full", "Q2", "Below", 0.0187, 0.0001,
  "Full", "Q2", "Above", 0.0106, 0.0001,
  "Full", "Q3", "Below", 0.0208, 0.0001,
  "Full", "Q3", "Above", 0.0125, 0.0001,
  "Full", "Q4", "Below", 0.0210, 0.0001,
...
plot_below <- plot_df %>%
  ...
  labs(
    #title = "Heat Response Slopes Above Breakpoint\nby Income Quintile",
    x = "Income Quintile",
    y = "Below Breakpoint Slope \n(% change in electricity use per °F)",
    fill = "Sample"
  ) +
  
  theme_nature() +
  coord_cartesian(ylim = c(0.015, .03)) +
  theme(
...
ggsave(
  filename = "figure_above_breakpoint.png",
  plot     = plot_above,
  width    = 7,
  height   = 5,
  units    = "in",
